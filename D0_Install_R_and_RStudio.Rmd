...
The installer for the latest version of R (assuming you're using a PC) can be downloaded <a href="https://cran.r-project.org/bin/windows/base/R-4.0.2-win.exe">here</a>. After it downloads, open and run the installer with default settings. Note that there's no need to pin R to your taskbar or add a shortcut to your desktop. For 99% of your needs, you'll run R within RStudio, and won't ever open R directly.
</details>
<br>
