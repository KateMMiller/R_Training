...
Three days is barely enough to scratch the surface on what you can do in R. My goal with this training is to help you get past the initial learning curve that can be really challenging to climb on your own, and to give you the skills you need to start to learning on your own. Hopefully this also helps build a community of R users in ACAD who can help and share code with each other. 
