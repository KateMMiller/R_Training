...
sort(unique(wetdat$Latin_Name)) # use your eyes to spot the "Alnus incana++"
...
sort(unique(wetdat$Latin_Name)) # using your eyes approach
...
<details><summary class='ques2'>Question 4: How would you take only QA/QC events and join the loc table to QA/QC events only?</summary>
