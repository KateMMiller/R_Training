...
```{r Data_subsetting_and_summarizing, child = "D1_M6_Subsetting_and_summarizing_dataframes.Rmd"}
...
```{r Saving_data, child = "D2_M4_Saving_data_to_file.Rmd"}
...
```{r Saving_to_shapefile, child = "D3_M2_Saving_to_shapefile.Rmd"}

```

```{r Plotting_with_ggplot2, child = "D3_M3_Plotting_with_ggplot2.Rmd"}
